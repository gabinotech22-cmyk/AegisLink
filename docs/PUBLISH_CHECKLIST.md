...
Action required: after merging a policy change, run `infra/deploy-web.sh` (on Windows,
double-click `infra/deploy-web.bat`: same deploy through Git Bash, plus the smoke test) and smoke-test
