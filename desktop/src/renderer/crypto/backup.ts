/**
 * Desktop mirror of mobile/src/crypto/backup.ts — same envelope, same KDFs
...
// Desktop runs on V8 with a real event loop: no Hermes next-tick patch needed.
const KDF_ASYNC_TICK_MS = 10;
