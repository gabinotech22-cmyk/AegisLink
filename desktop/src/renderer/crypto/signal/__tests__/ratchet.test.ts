 ...
 * (golden rule #5 + #11: the desktop ratchet port must carry its own regression
 * suite). Exercises the ratchet API directly (no Sealed Sender wrapper):
 * happy-path roundtrips plus replay, bit-flip, nonce reuse pressure,
